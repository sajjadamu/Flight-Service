    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            if (authenticationService.isValidRequestHeaders(request) && authenticationService.isAuthorised(request)) {
                ...
                error.put("status", Status.UNAUTHORIZED.getCode());
            ...
            e.printStackTrace();
            error.put("status", Status.BAD_REQUEST.getCode());
            ...
            e.printStackTrace();
            error.put("status", Status.INTERNAL_SERVER_ERROR.getCode());
        ...
        } catch (ServiceBlockerFoundException e) {
            e.printStackTrace();
            error.put("status", Status.INTERNAL_SERVER_ERROR.getCode());
            error.put("message", "Service Blocker found, Which breaks this functionality");
            authenticationService.sendErrorResponse(response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, error);
        }
    }
